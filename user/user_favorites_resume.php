...
if ($act == "add") {
    ...
    if ($add_return === "full") {
        ...
        $str = '<table width="100%" border="0" cellspacing="0" cellpadding="0" class="tableall">
            <tr>
                <td width="140" align="right"><img height="100" src="'.$_CFG['site_template'].'images/14.gif" /></td>
                <td>
                    <strong style="font-size:14px ; color:#0066CC;margin-left:20px">添加成功!共添加 '.$add_return.'份简历</strong>
                    <div style="border-top:1px #CCCCCC solid; line-height:180%; margin-top:10px; padding-top:10px; height:50px;margin-left:20px"  class="dialog_closed">
                        <a href="'.get_member_url(1, true).'company_recruitment.php?act=favorites_list" >查看人才库</a><br />
