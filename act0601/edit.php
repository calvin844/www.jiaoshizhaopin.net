...
if (empty($item)) {
    $link[0]['text'] = "马上参加";
    $link[0]['href'] = "/act0601/upload.php";
    showmsg('您还没上传作品！', 1, $link);
}
if ($act == "edit") {
    ...
    $smarty->display('act0601/edit.htm');
} else if ($act == "save") {
    ...
    updatetable(table('act_20170601'), $data, " uid='" . $uid . "'");
    $in_resume['photo'] = 1;
    ...
    $link[0]['text'] = "查看作品";
    $link[0]['href'] = "/act0601/details.php?id=" . intval($_POST['id']);
    showmsg('修改成功！', 1, $link);
