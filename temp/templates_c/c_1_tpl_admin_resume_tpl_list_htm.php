<?php /* V2.10 Template Lite 4 January 2007  (c) 2005-2007 Mark Dickenson. All rights reserved. Released LGPL. 2014-09-05 10:02 ?D1ú±ê×?ê±?? */  $_templatelite_tpl_vars = $this->_vars;
...
<div class="toptip">
	<h2>提示：</h2>
	<p>
新增模板只需将模板文件上传至 ./templates/tpl_resume目录下，更多模版请到 <a href="http://www.74cms.com/bbs" target="_blank" style="color:#009900">[论坛]</a> 获取。<br />
...
<div class="toptit">简历模版</div>
<form id="form1" name="form1" method="post" action="?act=resume_tpl_save">
<?php echo $this->_vars['inputtoken']; ?>
  ...
  <tr>
    <td width="225"><img src="../templates/tpl_resume/<?php echo $this->_vars['li']['tpl_dir']; ?>
...
"  class="input_text_200" />
      ...
      <tr>
		...
		<label>
          <input name="tpl_personal" type="radio" value="<?php echo $this->_vars['li']['tpl_dir']; ?>
" <?php if ($this->_vars['li']['tpl_dir'] == $this->_vars['QISHI']['tpl_personal']): ?>checked="checked" <?php endif; ?>/>
        </label></td>
      </tr>
	  <tr>
	...
	<table width="100%" border="0" cellspacing="10" cellpadding="0" class="admin_list_btm">
      <tr>
        <td>
		 ...
		 <input type="button" name="Submit22" value="刷新" class="admin_submit"    onclick="window.location='?act=refresh_tpl&type=2&tpl_dir=tpl_resume&<?php echo $this->_vars['urltoken']; ?>
'"/>
		</td>
