...
//var_dump($mailconfig_tmp);exit;
    ...
    $html = "您与<a target='_blank' href='http://www.jiaoshizhaopin.net/'>教师招聘网</a>合作的项目有了新数据提交，数据如下：<br/>姓名：" . $data['item1'] . "<br/>" . "手机号：" . $data['item2'] . "<br/>" . "微信号：" . $data['item3'] . "<br/><br/>更多详情，请<a target='_blank' href='http://www.jiaoshizhaopin.net/bd002/list.php'>点击这里</a>";
    smtp_mail('ToSales@ukd360.com', $_CFG['site_name'] . "项目有了新数据", $html, $mc['smtpfrom'], $_CFG['site_name']);
