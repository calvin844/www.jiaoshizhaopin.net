...
if(!$flag) {showmsg('企业和猎头顾问可转换简历。个人仅能装换自己的简历！',1);exit();}
...
<table width="700" border="1" align="center" cellpadding="5" cellspacing="0" bordercolor="#333333" >
  ...
  <tr>
    <td width="110" align="right">语言能力： </td>
...
<table width="700" border="1" align="center" cellpadding="5" cellspacing="0" bordercolor="#333333" >
  <tr>
    <td colspan="4" bgcolor="#E1EEF4">项目经历</td>
  </tr>';
  if($val['project_list']){
	  ...
	  $htm.=' <tr>
		...
		项目名称：'.$tli['projectname'].'<br />
		公司名称：'.$tli['companyname'].'<br />
		项目职务：'.$tli['projectposition'].'<br />
		项目描述：'.$tli['description'].'<br />
		项目职责：'.$tli['projectduty'].'<br />
		项目业绩：'.$tli['achievements'].'
		</td>
	  </tr>';
	  }
  }else{
	 $htm.='<tr><td colspan="4" bgcolor="#FFFFFF">没有填写项目经历</td></tr>';
  }
$htm.='</table>
<br />
<br />
<table width="700" border="1" align="center" cellpadding="5" cellspacing="0" bordercolor="#333333" >
  <tr>
    <td colspan="2" bgcolor="#E1EEF4">附加信息</td>
  </tr>
  <tr>
    <td width="110" align="right">附加信息： </td>
...
elseif($_CFG['showmanagerresumecontact']=='2')//联系方式：会员下载后可见
{
