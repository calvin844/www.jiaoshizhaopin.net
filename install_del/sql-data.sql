...
(NULL, 1, 2, 'QS_companycomment', '企业评论列表页', 'company/company-comment.php', 'company-comment.htm', 'company/company-comment-($id)-($page).htm', 0, 0, 'jobs', '', '', ''),
(NULL, 1, 3, 'QS_companycommentshow', '企业评论详细页', 'company/company-comment-show.php', 'company-comment-show.htm', 'company/company-comment-show-($id).htm', 0, 0, 'jobs', '', '', ''),
(NULL, 1, 2, 'QS_companyimg', '企业图片列表页', 'company/company-img.php', 'company-img.htm', 'company/company-img-($id)-($page).htm', 0, 0, 'jobs', '', '', ''),
...
INSERT INTO `qs_gifts_type` (`t_id`, `t_name`, `t_repeat`, `t_pre`, `t_starttime`, `t_endtime`, `t_effective`, `t_amount`) VALUES (1, '未命名礼品卡', 1, '74cms', 0, 0, 1, 100);
